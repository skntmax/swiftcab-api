    ...
    verifyMailLink: function (req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let userVarify = yield auth_service_1.default.verifyMailLink({ userId: Number(userId), username, role: Number((_a = req.query) === null || _a === void 0 ? void 0 : _a.role), roleTypeName });
