...
const customer_index_1 = __importDefault(require("./routes/customer/customer.index"));
const driver_index_1 = __importDefault(require("./routes/driver/driver.index"));
...
app.use(`/${exports.version}/customer`, customer_index_1.default);
...
app.use(`/${exports.version}/driver`, driver_index_1.default);
